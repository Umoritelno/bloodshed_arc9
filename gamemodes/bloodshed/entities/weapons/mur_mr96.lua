...
SWEP.ViewModel = "models/murdered/weapons/c_ins2_revolver_mr96.mdl"

SWEP.WorldModel = "models/weapons/w_357.mdl" -- If you are going to MirrorVMWM: Put here some optimized model with collisions. Css/hl2 weapon worldmodels that are included in gmod are great for it - like "models/weapons/w_rif_m4a1.mdl"
...
SWEP.DamageMax = 56 -- Damage done at point blank range
...
SWEP.ShootSound = ")murdered/weapons/revolver/revolver_fp.wav"						   -- Fire
...
SWEP.DistantShootSound = ")murdered/weapons/revolver/revolver_dist.wav"				   -- Distant fire
...
SWEP.HideBones = {"Speed_Loader"} -- bones to hide in third person and customize menu. {"list", "of", "bones"}
...
SWEP.NonTPIKAnimReload = ACT_HL2MP_GESTURE_RELOAD_REVOLVER -- Non TPIK
