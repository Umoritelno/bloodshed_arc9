...
SWEP.ViewModel = "models/murdered/weapons/c_izh43_sawnoff.mdl"
...
SWEP.WorldModelOffset = {
	Pos = Vector(-9, 3.2, -4), -- non tpik (while on ground, on npc etc)
	Ang = Angle(0, 0, 180),
	TPIKPos = Vector(-11, 4, -2), -- arc9_tpik 1, you can make cool poses with it
...
SWEP.DispersionSpread = 0.05 -- SWEP.Spread will be clump spread, and this will be dispersion of clump
...
SWEP.ShootSound = ")murdered/weapons/toz_shotgun/toz_fp.wav"							-- Fire
...
SWEP.DistantShootSound = ")murdered/weapons/toz_shotgun/toz_dist.wav"					-- Distant fire
...
SWEP.DryFireSound = ")murdered/weapons/toz_shotgun/handling/toz_empty.wav"
...
SWEP.Animations = {
	...
	["reload"] = {
		...
		EventTable = {
			...
			{
				t = 2.1, -- in seconds
				s = "murdered/weapons/toz_shotgun/handling/toz_single_shell_insert_1.wav", -- sound to play
				c = CHAN_ITEM, -- sound channel
			},
			{
				t = 2.9, -- in seconds
	...
	["reload_empty"] = {
		...
		EventTable = {
			...
			{
				t = 2.4, -- in seconds
				s = "murdered/weapons/toz_shotgun/handling/toz_single_shell_insert_2.wav", -- sound to play
				c = CHAN_ITEM, -- sound channel
			},
			{
				t = 3.2, -- in seconds
