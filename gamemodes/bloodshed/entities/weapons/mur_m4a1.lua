...
SWEP.ViewModel = "models/murdered/weapons/c_pd2_m4a1.mdl"

SWEP.WorldModel = "models/weapons/w_rif_m4a1.mdl" -- If you are going to MirrorVMWM: Put here some optimized model with collisions. Css/hl2 weapon worldmodels that are included in gmod are great for it - like "models/weapons/w_rif_m4a1.mdl"
...
SWEP.ShootSound = ")murdered/weapons/m4a1/m4a1_fp.wav"                            -- Fire
...
SWEP.DistantShootSound = ")murdered/weapons/m4a1/m4a1_dist.wav"                    -- Distant fire
...
SWEP.CrouchPos = Vector(2.5, -2, -2.5)
...
SWEP.Animations = {
    ...
    ["reload"] = {
        ...
        EventTable = {

            {
                ...
                s = "murdered/weapons/m4a1/handling/m4a1_magout.wav", -- sound to play
...

            {
                ...
                s = "murdered/weapons/m4a1/handling/m4a1_magin.wav", -- sound to play
...

            {
                ...
                s = "murdered/weapons/m4a1/handling/m4a1_boltrelease.wav", -- sound to play
    ...
    ["draw"] = {
        ...
        Source = "amcar_draw_unsil", -- QC sequence source, can be {"table", "of", "strings"} or "string"
