...
SWEP.ViewModel = "models/murdered/weapons/tfa_ins2/c_sks.mdl"
...
SWEP.WorldModelOffset = {
	Pos = Vector(-5, 4.2, -7), -- non tpik (while on ground, on npc etc)
	Ang = Angle(0, 0, 180),
...
SWEP.ShootSound = ")murdered/weapons/sks/sks_fp.wav"							-- Fire
...
SWEP.DistantShootSound = ")murdered/weapons/sks/sks_dist.wav"					-- Distant fire
...
SWEP.DryFireSound = ")murdered/weapons/sks/handling/sks_empty.wav"
...
SWEP.Animations = {
	["ready"] = {
		...
		EventTable = {
			{
				t = 0.5, -- in seconds
				s = "murdered/weapons/sks/handling/sks_boltback.wav", -- sound to play
				c = CHAN_ITEM, -- sound channel
			},
			{
				t = 0.7, -- in seconds
				s = "murdered/weapons/sks/handling/sks_boltrelease.wav", -- sound to play
				c = CHAN_ITEM, -- sound channel
			},
		},
	},
	...
	["reload"] = {
		...
		EventTable = {
			{
				t = 0.5, -- in seconds
				s = "murdered/weapons/sks/handling/sks_magout.wav", -- sound to play
				c = CHAN_ITEM, -- sound channel
			},
			{
				t = 2, -- in seconds
				s = "murdered/weapons/sks/handling/sks_magin.wav", -- sound to play
				c = CHAN_ITEM, -- sound channel
			},
		},
	},
