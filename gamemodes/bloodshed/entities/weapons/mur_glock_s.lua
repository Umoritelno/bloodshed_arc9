...
SWEP.TakedownType = "pistol"

SWEP.RagdollType = "USPs"

SWEP.Slot = 1



SWEP.PrintName = "Glock 17 Silenced"
...
SWEP.WorldModel = "models/weapons/w_pist_usp.mdl" -- If you are going to MirrorVMWM: Put here some optimized model with collisions. Css/hl2 weapon worldmodels that are included in gmod are great for it - like "models/weapons/w_rif_m4a1.mdl"
...
SWEP.WorldModelOffset = {
	...
	TPIKPos = Vector(-6, 4, -6), -- arc9_tpik 1, you can make cool poses with it
...
SWEP.ShootSound = ")murdered/weapons/m9/m9_suppressed_fp.wav"							-- Fire

SWEP.ShootSoundIndoor = nil					 -- Fire indoors

SWEP.ShootSoundSilenced = ")murdered/weapons/m9/m9_suppressed_fp.wav"					-- Fire silenced
...
SWEP.DistantShootSound = ")murdered/weapons/m1911/m1911_dist.wav"					-- Distant fire
...
SWEP.DryFireSound = ")murdered/weapons/m1911/handling/m1911_empty.wav"
...
SWEP.Animations = {
	...
	["reload"] = {
		...
		EventTable = {

			{
				...
				s = "murdered/weapons/m1911/handling/m1911_magout.wav", -- sound to play
...

			{
				...
				s = "murdered/weapons/m1911/handling/m1911_magin.wav", -- sound to play
...

			{
				...
				s = "murdered/weapons/m1911/handling/m1911_maghit.wav", -- sound to play
	...
	["draw"] = {
		...
		Source = "chimano88_draw", -- QC sequence source, can be {"table", "of", "strings"} or "string"
		...
		EventTable = {

			{
				...
				s = "murdered/weapons/m1911/handling/m1911_boltback.wav", -- sound to play
...

			{
				...
				s = "murdered/weapons/m1911/handling/m1911_boltrelease.wav", -- sound to play
	...
	["holster"] = { // TODO: Сделать отдельную анимацию убирания
