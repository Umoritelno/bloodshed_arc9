...
SWEP.ViewModel = "models/murdered/weapons/c_ins2_revolver_sw500.mdl"
...
SWEP.DamageMax = 76 -- Damage done at point blank range
...
SWEP.Animations = {
	...
	["ready"] = {
		...
		EventTable = {

			{
				...
				s = "murdered/weapons/universal/uni_pistol_draw_02.wav", -- sound to play
	...
	["holster"] = {
		...
		Time = 1, -- overrides the duration of the sequence
	...
	["draw"] = {
		...
		Time = 1.5, -- overrides the duration of the sequence
