...
SWEP.ViewModel = "models/murdered/weapons/tfa_ins2/c_spas12_bri.mdl"
...
SWEP.WorldModelOffset = {
	...
	Pos = Vector(-4, 3.2, -6), -- non tpik (while on ground, on npc etc)

	Ang = Angle(0, 0, 180),

	TPIKPos = Vector(3, 4, -5), -- arc9_tpik 1, you can make cool poses with it
...
SWEP.Animations = {
	...
	["draw"] = {
		...
		Time = 0.9, -- overrides the duration of the sequence
