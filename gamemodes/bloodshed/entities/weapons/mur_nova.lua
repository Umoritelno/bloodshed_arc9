...
SWEP.ViewModel = "models/murdered/weapons/tfa_ins2/c_nova.mdl"
...
SWEP.WorldModelOffset = {
	...
	Pos = Vector(-2, 3.2, -6), -- non tpik (while on ground, on npc etc)
...
SWEP.SprintPos = Vector(10, -3, -4)

SWEP.SprintAng = Angle(50, 10, 0)
