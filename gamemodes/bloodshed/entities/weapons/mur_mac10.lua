...
SWEP.ViewModel = "models/murdered/weapons/tfa/zmirli/c_mac10.mdl"

SWEP.WorldModel = "models/murdered/weapons/tfa/zmirli/w_mac10.mdl" -- If you are going to MirrorVMWM: Put here some optimized model with collisions. Css/hl2 weapon worldmodels that are included in gmod are great for it - like "models/weapons/w_rif_m4a1.mdl"
...
SWEP.WorldModelOffset = {
    ...
    Pos = Vector(-12, 4.2, -7), -- non tpik (while on ground, on npc etc)

    Ang = Angle(0, 0, 180),

    TPIKPos = Vector(-16, 4, -6), -- arc9_tpik 1, you can make cool poses with it
    ...
    ["ready"] = {
        ...
        EventTable = {

            {
                ...
                s = "murdered/weapons/m4a1/handling/m4a1_boltback.wav", -- sound to play
