...
SWEP.RagdollType = "Bat"
SWEP.ViewModelFOV = 90
SWEP.ViewModelFlip = false
SWEP.ViewModel = "models/murdered/weapons/tfa_l4d_mw2019/melee/c_wood_bat.mdl"
SWEP.WorldModel = "models/murdered/weapons/tfa_l4d_mw2019/melee/w_wood_bat.mdl"
SWEP.BobScale = 2.5
SWEP.SwayScale = 1.8
SWEP.UseHands = true
SWEP.Primary.Ammo = "no"
SWEP.Primary.Delay = 1.3
SWEP.Primary.Throw = 10
...
SWEP.Secondary.Delay = 1.9
SWEP.Secondary.Throw = 15
SWEP.Secondary.Damage = 25
SWEP.WorldModelPosition = Vector(5, -1.6, -8)
...
function SWEP:Deploy(wep)
	...
	self:EmitSound("murdered/weapons/tfa_l4d_mw2019/baseball_bat/cricket_bat_deploy_1.wav")
end
...
function SWEP:PrimaryAttack()
	local angle = Angle(-self.Primary.Throw, 5, 0)
	local ply = self:GetOwner()
	...
	ply:EmitSound("murdered/weapons/tfa_l4d_mw2019/baseball_bat/bat_swing_miss" .. math.random(1, 2) .. ".wav")
	...
	if SERVER then
		timer.Simple(0.35, function()
			...
			if IsValid(ent) and (ent:IsPlayer() or ent:IsNPC() or ent:GetClass() == "prop_ragdoll") then
				...
				ply:EmitSound("murdered/weapons/tfa_l4d_mw2019/baseball_bat/melee_cricket_bat_0" .. math.random(1, 3) .. ".wav")
			elseif tr.Hit then
				if IsValid(ent) then
					local dm = DamageInfo()
					dm:SetDamage(self.Primary.Damage)
				...
				ply:EmitSound("murdered/weapons/tfa_l4d_mw2019/baseball_bat/bat_impact_world" .. math.random(1, 2) .. ".wav")
			end
		end)
	end
