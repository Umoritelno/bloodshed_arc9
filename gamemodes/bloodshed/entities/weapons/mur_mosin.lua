...
SWEP.TakedownType = "sniper"

SWEP.RagdollType = "AWP"
...
SWEP.ViewModel = "models/murdered/weapons/c_ins2_mosin_nagant.mdl"

SWEP.WorldModel = "models/weapons/w_snip_scout.mdl" -- If you are going to MirrorVMWM: Put here some optimized model with collisions. Css/hl2 weapon worldmodels that are included in gmod are great for it - like "models/weapons/w_rif_m4a1.mdl"
...
SWEP.WorldModelOffset = {
	...
	Pos = Vector(-7, 3.2, -6), -- non tpik (while on ground, on npc etc)

	Ang = Angle(-5, -1, 180),

	TPIKPos = Vector(1, 4, -6), -- arc9_tpik 1, you can make cool poses with it
...
SWEP.ImpactForce = 20 -- Force that bullets apply on hit
...
SWEP.RicochetChance = 0.4 -- If the angle is right, what is the chance that a ricochet can occur?
...
SWEP.ShootSound = ")murdered/weapons/mosin/mosin_fp.wav"						   -- Fire
...
SWEP.DistantShootSound = ")murdered/weapons/mosin/mosin_dist.wav"				   -- Distant fire
...
SWEP.DryFireSound = ")murdered/weapons/mosin/handling/mosin_empty.wav"
	...
	["ready"] = {
		...
		EventTable = {

			{
				...
				s = "murdered/weapons/mosin/handling/mosin_boltback.wav", -- sound to play
...

			{
				...
				s = "murdered/weapons/mosin/handling/mosin_boltforward.wav", -- sound to play
	...
	["reload_insert_bullet_1"] = {
		...
		EventTable = {

			{
				...
				s = "murdered/weapons/mosin/handling/mosin_bulletin.wav", -- sound to play
