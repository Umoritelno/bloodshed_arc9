...
SWEP.RagdollType = "Hatchet"
SWEP.ViewModelFOV = 100
SWEP.ViewModelFlip = false
SWEP.ViewModel = "models/murdered/yurie/eft/weapons/valuable_wyccaxe.mdl"
SWEP.WorldModel = "models/murdered/yurie/eft/weapons/world/valuable_wyccaxe.mdl"
SWEP.BobScale = 2.5
SWEP.SwayScale = 1.8
SWEP.UseHands = true
