...
SWEP.Melee = true
SWEP.MeleeHealth = 120
SWEP.BladeWeapon = true
SWEP.TakedownType = "knife"
SWEP.RagdollType = "CombatKnife"
SWEP.ViewModelFOV = 90
SWEP.ViewModelFlip = false
SWEP.ViewModel = "models/murdered/yurie/eft/weapons/izhmash_6x5.mdl"
SWEP.WorldModel = "models/murdered/yurie/eft/weapons/world/izhmash_6x5.mdl"
SWEP.BobScale = 2.5
SWEP.SwayScale = 1.8
SWEP.UseHands = true
