...
SWEP.RagdollType = "GolfClub"
SWEP.ViewModelFOV = 80
SWEP.ViewModelFlip = false
SWEP.ViewModel = "models/murdered/weapons/tfa_l4d_mw2019/melee/c_golfclub.mdl"
SWEP.WorldModel = "models/murdered/weapons/tfa_l4d_mw2019/melee/w_golfclub.mdl"
SWEP.BobScale = 2.5
SWEP.SwayScale = 1.8
SWEP.UseHands = true
...
SWEP.Secondary.Throw = 5
SWEP.Secondary.Damage = 3
SWEP.WorldModelPosition = Vector(2, -1, 1)
...
function SWEP:Deploy(wep)
	...
	self:EmitSound("murdered/weapons/tfa_l4d_mw2019/golf_club/golf_club_deploy_1.wav")
end
...
function SWEP:PrimaryAttack()
	...
	ply:EmitSound("murdered/weapons/tfa_l4d_mw2019/golf_club/wpn_golf_club_swing_miss" .. math.random(1, 2) .. ".wav")
	...
	if SERVER then
		timer.Simple(0.2, function()
			...
			if IsValid(ent) and (ent:IsPlayer() or ent:IsNPC() or ent:GetClass() == "prop_ragdoll") then
				...
				ply:EmitSound("murdered/weapons/tfa_l4d_mw2019/golf_club/wpn_golf_club_melee_0" .. math.random(1, 2) .. ".wav")
			elseif tr.Hit then
				if IsValid(ent) then
					local dm = DamageInfo()
					dm:SetDamage(self.Primary.Damage)
				...
				ply:EmitSound("murdered/weapons/tfa_l4d_mw2019/golf_club/wpn_golf_club_impact_world" .. math.random(1, 2) .. ".wav")
			end
		end)
	end
