...
SWEP.RagdollType = "SurvivalAxe"
SWEP.ViewModelFOV = 100
SWEP.ViewModelFlip = false
SWEP.ViewModel = "models/murdered/yurie/eft/weapons/strider_crash_axe.mdl"
SWEP.WorldModel = "models/murdered/yurie/eft/weapons/world/strider_crash_axe.mdl"
SWEP.BobScale = 2.5
SWEP.SwayScale = 1.8
SWEP.UseHands = true
...
SWEP.WorldModelPosition = Vector(3.5, -4, -6)
...
function SWEP:PrimaryAttack()
	...
	ply:EmitSound("murdered/weapons/melee/axe_swing.mp3")
