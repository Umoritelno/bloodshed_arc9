...
SWEP.RagdollType = "Crowbar"
SWEP.ViewModelFOV = 90
SWEP.ViewModelFlip = false
SWEP.ViewModel = "models/murdered/yurie/eft/weapons/gf_crowbar.mdl"
SWEP.WorldModel = "models/murdered/yurie/eft/weapons/world/gf_crowbar.mdl"
SWEP.BobScale = 2.5
SWEP.SwayScale = 1.8
SWEP.UseHands = true
SWEP.Primary.Ammo = "no"
SWEP.Primary.Delay = 1
SWEP.Primary.Throw = 11
...
SWEP.WorldModelPosition = Vector(3.8, -4.5, -8)
