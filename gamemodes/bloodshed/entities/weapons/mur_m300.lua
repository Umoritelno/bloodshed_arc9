...
SWEP.ViewModel = "models/murdered/weapons/tfa_ins2/c_m500.mdl"

SWEP.WorldModel = "models/weapons/w_shot_m3super90.mdl" -- If you are going to MirrorVMWM: Put here some optimized model with collisions. Css/hl2 weapon worldmodels that are included in gmod are great for it - like "models/weapons/w_rif_m4a1.mdl"
...
SWEP.WorldModelOffset = {
    ...
    Pos = Vector(-12, 3.2, -6), -- non tpik (while on ground, on npc etc)

    Ang = Angle(0, 0, 180),

    TPIKPos = Vector(-4, 4, -5), -- arc9_tpik 1, you can make cool poses with it
...
SWEP.Animations = {
    ...
    ["cycle"] = {
        ...
        EventTable = {

            {
                ...
                s = ")murdered/weapons/toz_shotgun/pump.wav", -- sound to play
    ...
    ["reload_insert_bullet_1"] = {
        ...
        EventTable = {

            {
                ...
                s = "murdered/weapons/toz_shotgun/handling/toz_single_shell_insert_3.wav", -- sound to play
    ...
    ["draw"] = {
        ...
        Time = 0.85, -- overrides the duration of the sequence
