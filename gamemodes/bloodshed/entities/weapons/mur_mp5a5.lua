...
SWEP.ViewModel = "models/murdered/weapons/c_inss2_mp5a5.mdl"
SWEP.WorldModel = "models/weapons/w_smg_mp5.mdl" -- If you are going to MirrorVMWM: Put here some optimized model with collisions. Css/hl2 weapon worldmodels that are included in gmod are great for it - like "models/weapons/w_rif_m4a1.mdl"
...
SWEP.WorldModelOffset = {
	Pos = Vector(-4, 3.2, -7.5), -- non tpik (while on ground, on npc etc)
	Ang = Angle(0, 0, 180),
...
SWEP.ShootSound = ")murdered/weapons/mp5k/mp5k_fp.wav"							-- Fire
...
SWEP.DistantShootSound = ")murdered/weapons/mp5k/mp5k_dist.wav"					-- Distant fire
...
SWEP.DryFireSound = ")murdered/weapons/mp5k/handling/mp5k_empty.wav"
...
SWEP.Animations = {
	["ready"] = {
		...
		EventTable = {
			{
				t = 1.2, -- in seconds
				s = "murdered/weapons/mp5k/handling/mp5k_magin.wav", -- sound to play
				c = CHAN_ITEM, -- sound channel
			},
			{
				t = 2.1, -- in seconds
				s = "murdered/weapons/mp5k/handling/mp5k_boltrelease.wav", -- sound to play
				c = CHAN_ITEM, -- sound channel
			},
		},
	},
	...
	["reload"] = {
		...
		EventTable = {
			{
				t = 0.3, -- in seconds
				s = "murdered/weapons/mp5k/handling/mp5k_magout.wav", -- sound to play
				c = CHAN_ITEM, -- sound channel
			},
			{
				t = 1.4, -- in seconds
	...
	["reload_empty"] = {
		...
		EventTable = {
			{
				t = 0.4, -- in seconds
				s = "murdered/weapons/mp5k/handling/mp5k_boltback.wav", -- sound to play
				c = CHAN_ITEM, -- sound channel
			},
			{
				t = 1.2, -- in seconds
