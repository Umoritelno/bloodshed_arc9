...
SWEP.ViewModel = "models/murdered/weapons/tfa_ins2/c_pm.mdl"
...
SWEP.WorldModelOffset = {
	Pos = Vector(-10, 3.2, -4), -- non tpik (while on ground, on npc etc)
	Ang = Angle(0, 0, 180),
...
SWEP.ShootSound = ")murdered/weapons/makarov/makarov_fp.wav"							-- Fire
...
SWEP.DistantShootSound = ")murdered/weapons/makarov/makarov_dist.wav"					-- Distant fire
...
SWEP.DryFireSound = ")murdered/weapons/makarov/handling/makarov_empty.wav"
...
SWEP.Animations = {
	...
	["reload"] = {
		...
		EventTable = {
			{
				t = 0.3, -- in seconds
				s = "murdered/weapons/makarov/handling/makarov_magout.wav", -- sound to play
				c = CHAN_ITEM, -- sound channel
			},
			{
				t = 1.3, -- in seconds
				s = "murdered/weapons/makarov/handling/makarov_magin.wav", -- sound to play
				c = CHAN_ITEM, -- sound channel
			},
			{
				t = 1.8, -- in seconds
				s = "murdered/weapons/makarov/handling/makarov_maghit.wav", -- sound to play
				c = CHAN_ITEM, -- sound channel
		    },
        },
    },
    ["reload_empty"] = {
        ...
        EventTable = {
            ...
            {
                t = 2.3, -- in seconds
                s = "murdered/weapons/makarov/handling/makarov_boltrelease.wav", -- sound to play
                c = CHAN_ITEM, -- sound channel
            },
        },
    },
